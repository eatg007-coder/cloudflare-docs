...
A _domain_ or _domain name_ (also known as a _zone_) is the location of a website or application, or what an end user types into their browser to get to your website (`s.uk.com`).
...
For more details about subdomains (`www.s.uk.com` or `blog.s.uk.com`), refer to [Manage subdomains](/fundamentals/manage-domains/manage-subdomains/).
