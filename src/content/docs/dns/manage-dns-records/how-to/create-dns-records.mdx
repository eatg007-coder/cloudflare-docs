Subject: s.uk.com still "Invalid nameservers" — parent shows Cloudflare NS

Hello Cloudflare Support,

Domain: s.uk.com
Account email: eatg007@gmail.com
Cloudflare-assigned NS: brady.ns.cloudflare.com, pat.ns.cloudflare.com

External lookup currently returns:
[paste the exact `dig NS s.uk.com +short` output here]

Parent DNS has NS records delegating s.uk.com to Cloudflare and DNSSEC is disabled. Please validate the zone and advise why the dashboard still shows "Invalid nameservers."
